      ...
      <div className="container">
        ...
        <ul className="nav nav-tabs" id="profileTabs">
          <li className="nav-item">
            <a 
              className={`nav-link ${activeTab === 'basicDetails' ? 'active' : ''}`}
                ...
                <div className="row">
                  <div className="col-md-6  mb-3">
                    <div className="form-group">
                      ...
                      <Field type="text" name="addressOne" className="form-control" />
                      <ErrorMessage
                        name="addressOne"
                        component="div"
                        className="text-danger"
                  ...
                  <div className="col-md-6  mb-3">
                    <div className="form-group">
                      ...
                      <Field type="text" name="addressTwo" className="form-control" />
                      <ErrorMessage
                        name="addressTwo"
                        component="div"
                        className="text-danger"
                ...
                <div className="row">
                  <div className="col-md-6  mb-3">
                    <div className="form-group">
                      ...
                      <Field type="number" name="kids" className="form-control" />
