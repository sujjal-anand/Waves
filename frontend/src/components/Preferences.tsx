...
const token = localStorage.getItem("token")
  ...
  const validationSchema = Yup.object({
    ...
    cholesterol: Yup.number()
      .required("Cholesterol value is required"),
            ...
            <Form>
              ...
              <div className="row mb-3">
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="weightIn" value="kg" />
                      <label className="form-check-label">Kg</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="weightIn" value="lbs" />
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="heightIn" value="cm" />
                      <label className="form-check-label">cm</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="heightIn" value="ft/inche" />
              ...
              <div className="row mb-3">
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <input type="radio" className="form-check-input" name="bloodGlucoseIn" value="mmol/l" />
                      <label className="form-check-label">mmol/l</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="bloodGlucoseIn" value="mg/dL" />
                      <label className="form-check-label">mg/dL</label>
                    </div>
                  </div>
                  <Field type="text" placeholder='BloodGlucose' name='bloodGlucose' />
                  <ErrorMessage
                    name="bloodGlucose"
                    component="div"
                  />
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="cholesterolIn" value="mmol/l" />
                      <label className="form-check-label">mmol/l</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="cholesterolIn" value="mg/dL" />
                      <label className="form-check-label">mg/dL</label>
                    </div>
                  </div>
                  <Field type="text" placeholder='Cholesterol' name='cholesterol' />
                  <ErrorMessage
                    name="cholesterol"
                    component="div"
                  />
              ...
              <div className="row mb-3">
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="bloodPressureIn" value="kPa" />
                      <label className="form-check-label">kPa</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="bloodPressureIn" value="mmHg" />
                      <label className="form-check-label">mmHg</label>
                    </div>
                  </div>
                  <Field type="text" placeholder='BloodPressure' name='bloodPressure' />
                  <ErrorMessage
                    name="bloodPressure"
                    component="div"
                  />
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="distanceIn" value="km" />
                      <label className="form-check-label">km</label>
                    </div>
                    <div className="form-check">
                      <Field type="radio" className="form-check-input" name="distanceIn" value="miles" />
              ...
              <div className="mb-3">
                <label className=" row form-label border-top border-bottom">Communication Type</label>
                <div className="row">
                  <div className="col-6">
                    ...
                    component="div"
                  />
                      <label htmlFor="systemEmail" className="form-check-label">System Emails</label>
                    </div>
                  </div>
                  ...
                  <div className="col-6">
                    <div className="form-check form-switch">
                      <Field className="form-check-input" type="checkbox" name="memberServicesEmail" />
                      <ErrorMessage
                  ...
                  <div className="col-6">
                    <div className="form-check form-switch">
                      <Field className="form-check-input" type="checkbox" name="phoneCall" />
                      <ErrorMessage
                    name="phoneCall"
                    component="div"
                  />
