  ...
  Create Waves
    ...
    <div className="photo ms-5 mb-0 main-img-div ">
      <div className="d-flex photo  ">
        ...
        <p className="mt-4 ms-4 text-white fs-5 fw-semibold"> {data?.user?.firstName} {data?.user?.lastName} </p>
      </div>
    </div>
          ...
          <Form encType="multipart/form-data">
            <div className="me-4 mb-3">
              <input
                type="file"
                name="media"
                onChange={(e: any) => setFieldValue('media', e.currentTarget.files[0])}
                className="form-control"
              />
              <ErrorMessage component="div" name="media" className="text-danger" />
            </div>
            <div className="me-4 mb-3">
              <Field
                name="text"
        ...
        {(data?.waves?.userWaves?.length>0) && (
          <>
            {data?.waves?.userWaves?.map((waveData:any)=>(
              <div className="p-1 wave-card rounded me-4 mb-3" key={waveData.id} >
                <div className='d-flex pb-0' >
                  ...
                  <div className='d-flex ' >
                    ...
                    <div className='ms-3 small' >
                      <p className='mb-0 mt-1 fw-bold cmn-clr ' >{ data?.user.email }</p>
